...
BLOG_AUTHOR = "Pittsburgh Python User Group"  # (translatable)
BLOG_TITLE = "Pittsburgh Python"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pghpython.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pghpython.org/"
BLOG_EMAIL = "contact@pgypython.org"
BLOG_DESCRIPTION = "Homepage of the Pittsburgh Python User Group"  # (translatable)
...
FILTERS = {
    ...
    ".css": ["postcss --use autoprefixer -r %s"],
}
...
SASS_OPTIONS = ['--load-path=vendor/bootstrap/scss/']
